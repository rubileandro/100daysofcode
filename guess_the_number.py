...
turns = 0
# Check Function to check user's guess against actual answer.
def check_answer(guess, answer, turns):
  """checks answer against guess. Returns the number of turns reminaing."""
  if guess > answer:
    print("Too high.")
    return turns -1
  elif guess < answer:
...
# game fucntion   
def game():
  # Choosing a random number between 1 andd 100.
